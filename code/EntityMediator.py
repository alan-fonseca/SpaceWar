...
from SpaceWar.code.PlayerShot import PlayerShot
...
class EntityMediator:
    ...
    def __verify_collision_entity(ent1, ent2):
        ...
        # Interações para definir se houve colisão (colisão de retângulos)
        if valid_interaction:
            if (
                ...
                # Entidades depreciando a vida do outro
                ent1.health -= ent2.damage
                ent2.health -= ent1.damage

                # Como identificar quem causou último dano
                ent1.last_dmg = ent2.name
                ent2.last_dmg = ent1.name

    @staticmethod
    # Para verificar qual inimigo foi "morto" por qual player
